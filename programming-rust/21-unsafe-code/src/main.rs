...
//  Ongoing: 2022-12-05T23:51:03AEDT how much of the comments in the book for example 'GapBuffer' are neccessary / not-redundent?
//  }}}
#![allow(unused)]
#![allow(non_snake_case)]
#![allow(non_camel_case_types)]

//  Continue: 2022-12-06T00:04:08AEDT assert correct GapBuffer behaviour
...
fn example_raw_pointers()
{
    ...
    //  Example: Gap buffer
    //  Emacs uses a gap buffer, which can insert/delete characters in constant time, as it keeps its spare capacity at the edit location.
    //  (this example does not <consider/use/validate> UTF8)
    mod gap {
        use std;
        use std::ops::Range;
